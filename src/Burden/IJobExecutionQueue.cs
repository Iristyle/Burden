...
{	
		...
		: IDisposable
	{
		...
		int StartAsManyAs(int maxConcurrentlyRunning);

		/// <summary>	Cancel outstanding jobs, which will result in cancellation Notifications being pushed through the WhenJobCompletes observable. </summary>
